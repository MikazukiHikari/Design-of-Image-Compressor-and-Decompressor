...
#compile -exact_map
#write -hierarchy -format verilog -output /home/user2/ms110/anson111/2023ivcad/Lab6/my/Lab6_X/top_syn.v
#write_sdf -version 2.1 -context verilog -load_delay net ./Lab6_X/top_syn.sdf